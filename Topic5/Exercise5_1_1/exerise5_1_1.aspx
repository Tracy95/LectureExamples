  ...
  <body>
    ...
    <!-- Flight Info -->
      ...
      ControlToValidate="flightDepartureDateTextBox" />
        ...
        <p>
          <asp:RequiredFieldValidator ID="validateFlightReturnDate" runat="server" ControlToValidate="flightReturnDateTextBox" 
            ErrorMessage="&lt;b&gt;Please enter a valid Return Date.&lt;/b&gt;&lt;p&gt;" />
          <p>
            ...
            <asp:Label ID="feedbackLabel" runat="server" 
              Text="Please enter your &lt;br /&gt;dates, then click &lt;br /&gt;the button" />
            <br />
            <br />
            <br />
