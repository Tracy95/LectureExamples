<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login2.aspx.cs" Inherits="LectureExamples.Topic5.Login2" %>
                  ...
                  <tr>
                    <td align="right" colspan="2">
                      <asp:Button ID="LoginButton" runat="server" BackColor="#FFFBFF"
                        ...
                        CommandName="Login" Font-Names="Verdana" Font-Size="0.8em"
                        ForeColor="#284775" Text="Log In" ValidationGroup="Login1" />
                    </td>
                  </tr>
                  <tr>
